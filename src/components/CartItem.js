          ...
          <div className="w-full flex flex-col">
            ...
            <div className="flex gap-x-2 h-[36px] text-sm pl-4 items-center">
              <div className="flex flex-1 max-w-[100px] items-center h-full border text-black font-medium">
                <div onClick={() => decreaseAmount(id)} className="flex-1 cursor-pointer flex justify-center items-center  h-full">
                  <IoMdRemove />
                </div>
              ...
              <div className="flex-1 flex justify-around items-center text-black font-medium">$ {price}</div>
