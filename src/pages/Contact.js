    ...
    <section className="pt-32 pb-12 lg:py-32 h-screen-[443px]">
      <div className="container mx-auto max-md:px-4">
        ...
        <div className="relative ">
          <div className=" absolute right-[40%] -top-[50%] left-[10%] max-md:-top-[25%]">
            <h1 className="text-[50px] uppercase font-medium leading-5 tracking-widest text-center max-md:text-[40px]">
              Contact us
            </h1>
          </div>
          <div className="mt-16 flex justify-between gap-11 max-md:block ">
            <div>
            ...
            <div className="flex max-md:mt-7">
              <iframe
