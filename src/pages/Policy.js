    ...
    <>
      <section className="pt-32 pb-12 lg:py-20 h-screen-[443px]">
        <div className="container mx-auto">
          ...
          <div className="mt-16 ">
            <div>
              <h2 className="text-3xl leading-9 font-bold">Privacy policy </h2>
              <p className="text-xl leading-9 mt-5">
                This Privacy Policy governs the manner in which E-shop collects,
                uses, maintains and discloses information collected from users
                (each, a "User"). This privacy policy applies to the Site and
                all products and services offered by E-Shop.
              </p>
            </div>
