          ...
          <div className="mt-16 ">
            <div>
              <p className="text-xl ">
                ...
                is India's foremost leading manufacturer, Exporter and
                wholesaler of Indian ethnic wear.
              </p>
            </div>
            <div className="mt-10">
              <p className="text-xl leading-9">
                ...
                Switzerland, Norway, Sweden, Austria, Mauritius, Ireland,
                Belgium, Finland, Denmark, India or anywhere in the world!
              </p>
            </div>
            <div className="mt-10">
              <p className="text-xl ">
                Today, when customers shop for clothing online, they are
                concerned about things:
              </p>
              <div className="mt-6 pl-10 leading-10">
                <p className="text-[20px] font-bold">1 . Is it Authentic?</p>
                <p className="text-[20px] font-bold">
                  2 . Would it be exactly similar to how it looks in the
                  picture?
                </p>
              </div>
            </div>
